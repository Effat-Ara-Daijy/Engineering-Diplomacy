...
<body>
    ...
    <main>
        <div class="energy-dip-page DiploCommon-page">
                    ...
                    <div class="DiploCommon-hero-img">
                        ...
                        <div class="DiploCommon-hero-topContent">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <h1>Energy Diplomacy</h1>
                                        <p>A Regional Hub for Energy Cooperation and Diplomacy</p>
                                        <div class="explore-btn">
                                        <a href="<?php echo $sSiteURL; ?>energy-diplomacy-details" class="ed-btn ed-btn-primary">
                                            Explore All
                                            <span>↗</span>
                                        </a>
                                    </div>
            ...
            <section class="DiploCommon-workshop-sec">
                <div class="container">
                    ...
                    <div class="DiploCommon-workshop-wrap">
                        <!-- <div class="DiploCommon-workshop-slider"> -->
                            ...
                            <!-- <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/energy_mumitm-4437.jpg" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                                            <h3>Renewal of the Ganges Energy Treaty</h3>
                                            <div class="d-flex justify-content-between">
                                                <div>
                            ...
                            <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/Hardinge_Bridge_Bangladesh_(4).jpg" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                            ...
                            <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/WhatsApp Image 2019-01-23 at 16.20.20.jpeg" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                                            <h3>A Theory-Practice Synthesis for Actionable Outcomes</h3>
                                            <div class="d-flex justify-content-between">
                                                <div>
                        ...
                        <div class="explore-btn">
                            <a href="workshop-list.php" class="ed-btn ed-btn-primary">
                                Explore All
                                <span>↗</span>
                            </a>
                        </div> -->
                        ...
                        <!-- <div class="DiploCommon-event-items">
                            <a href="event-details.php">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="DiploCommon-event-content">
                                            <h3>Remote Sensing for the Assessment of GroundEnergy Resources: Theory and Practical Applications</h3>
                                            <div class="DiploCommon-event-meta">
                                                <div class="DiploCommon-event-meta-flx">
                                                    <i class="fa-regular fa-calendar-days"></i>
                                                    <span>
                                            ...
                                            <p>In continuation of the Blue Peace Middle East Capacity-Building Project activities, supported by the Government of Switzerland, the Energy Diplomacy Center at the Jordan University of Science and Technology.</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
