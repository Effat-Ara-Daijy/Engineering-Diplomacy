<?php
$sInitialBN="Engineering Diplomacy";
$sInitialEN="Engineering Diplomacy";
$sSiteName="Engineering Diplomacy";
$sSiteTitle="Engineering Diplomacy";
$sAuthor="CERM";
$sDeveloper="eMythMakers.com";
$sEmail="cermoffice@cerm.buet.ac.bd";
$sMobile="+880-2-55666000-2";


//Local
// $sSiteURL="http://localhost/Engineering-Diplomacy/";
// $sCurrURL="http://localhost/Engineering-Diplomacy".$_SERVER["REQUEST_URI"];

//Web
// $sSiteURL="https://cerm.buet.ac.bd/engineeringdiplomacy/";
// $sCurrURL="https://cerm.buet.ac.bd/engineeringdiplomacy".$_SERVER["REQUEST_URI"];
...
//Web
// $sSiteURL="https://www.emythmaker.com/project/Template/Organization/Engineering-Diplomacy/Demo06/";
// $sCurrURL="https://www.emythmaker.com/project/Template/Organization/Engineering-Diplomacy/Demo06".$_SERVER["REQUEST_URI"];
...
$sCSSAnimate='<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css">';
$sCSSGoogleFont='<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&display=swap" rel="stylesheet">';
...
$sLogoURLFooter=$sSiteURL."media/common/logo2.png";
