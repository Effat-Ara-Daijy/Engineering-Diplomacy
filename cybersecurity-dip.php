...
<head>
    ...
    <title>Cybersecuirity Diplomacy</title>
...
<body>
    ...
    <main>
        <div class="Cybersecurity-dip-page DiploCommon-page">
            <section class="DiploCommon-pageHeroTop">
                <div class="container-fluid">
                    <div class="DiploCommon-hero-img">
                        <img class="img-fluid" src="media/imgAll/bg/pnaxi5pnaxi5pna.jpg" alt="" title="">
                        <div class="hero-overlay"></div>
                        <div class="DiploCommon-hero-topContent">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <h1>Cybersecurity Diplomacy</h1>
                                        <p>A Regional Hub for Cybersecurity Cooperation and Diplomacy</p>
                                        <div class="explore-btn">
                                        <a href="<?php echo $sSiteURL; ?>cybersecurity-diplomacy-details" class="ed-btn ed-btn-primary">
                                            Explore All
                                            <span>↗</span>
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-11 m-auto">
                            <div class="section-titleAll">
                                ...
                                <h2>
                                    Explore Cybersecurity Diplomacy 
                                    <span>Workshop</span>
                                </h2>
                            </div>
                        </div>
                        ...
                        <!-- <div class="DiploCommon-workshop-slider"> -->
                            ...
                            <!-- <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/4.webp" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                                            <h3>Renewal of the Ganges Cybersecurity Treaty</h3>
                                            <div class="d-flex justify-content-between">
                                                <div>
                            ...
                            <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/cyber-security-9dd0720e456138863395235037175733.webp" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                            ...
                            <div class="items">
                                <a href="Workshops-details.php">
                                    <div class="DiploCommon-workshop-Content">
                                        <img class="img-fluid" src="media/imgAll/bg/Ac-unsplash.jpg" alt="" title="">
                                        <div class="DiploCommon-workshop-ContentBox">
                                            <h3>A Theory-Practice Synthesis for Actionable Outcomes</h3>
                                            <div class="d-flex justify-content-between">
                                                <div>
